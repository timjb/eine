(function() {
  ...
  Card = require('../src/models/card').Card;
  Player = require('../src/models/player').Player;
  ServerGame = require('../src/models/server_game').ServerGame;
  ...
  io.sockets.on('connection', function(socket) {
    ...
    socket.on('join-game', function(name, id) {
      return handleErrors(function() {
        var game;
        game = getGame(id);
        if (!game) {
