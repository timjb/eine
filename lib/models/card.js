  ...
  (function(exports) {
    ...
    return exports.Card = (function() {
      ...
      Card.random = function() {
        var rand, randomCard, randomElement;
        rand = function(n) {
        ...
        randomCard = randomElement(this.deck());
        return new this({
          color: randomCard.get('color'),
          symbol: randomCard.get('symbol')
        });
      };
