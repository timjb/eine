(function() {
  ...
  App.Views.Player = (function() {
    ...
    Player.prototype._initDrawOrNextButton = function() {
      ...
      this.model.bind('current', __bind(function() {
        return this.drawOrNextButton.text("Draw a card");
      }, this));
      this.model.bind('change:didDraw', __bind(function() {
        if (this.model.get('didDraw')) {
          return this.drawOrNextButton.text("Next Player");
        }
      }, this));
      return this.model.bind('not:current', __bind(function() {
        return this.drawOrNextButton.text("");
      }, this));
    };
    ...
    Player.prototype.render = function() {
      if (this.isHuman) {
        $(this.el).append(this.handView.render().el).append(this.drawOrNextButton).append(this._eineButton());
      } else {
