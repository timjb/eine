(function() {
  ...
  App.Views.Hand = (function() {
    ...
    Hand.prototype.highlightMatchingCards = function(card) {
      var cardView, matches, _i, _len, _ref, _results;
      _ref = this.cardViews;
      _results = [];
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        console.log(matches);
        _results.push($(cardView.el)[matches ? 'addClass' : 'removeClass']('matching'));
      }
      return _results;
    };
    Hand.prototype._addCard = function(card) {
      ...
      cardEl = $('<li />').append(cardView.render().el).addClass('fade-in');
      if (index === 0) {
        cardEl.prependTo(this.el);
      } else {
        cardEl.insertAfter(this.$('li:not(.fade-out)').eq(index - 1));
      }
      return setTimeout((function() {
        return cardEl.removeClass('fade-in');
      }), 10);
    };
