(function() {
  ...
  App.Views.Game = (function() {
    ...
    Game.prototype.initialize = function(options, humanPlayer) {
      ...
      this.model.players.bind('add', this.render);
      return this.model.bind('winner', this.showWinner);
    };
    ...
    Game.prototype.showWinner = function(winner) {
      return $('<p class="win-message" />').text("" + (winner.escape('name')) + " has won!").appendTo(this.el);
    };
